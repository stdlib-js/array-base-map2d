...
```javascript
import map2d from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-map2d@v0.2.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/array-base-map2d/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/array-base-map2d/actions/workflows/test.yml?query=branch:v0.2.0
